...
IMG ?= clustersecret-operator-cop:latest
...
update-content: ## Update external resources used by this repository.
	...
	helm fetch oci://ghcr.io/sap/clustersecret-operator-helm/clustersecret-operator --untar --untardir pkg/operator/data/charts
